...
def wikiCrawler(citys):
    ...
    for city in citys:
        ...
        try:
            ...
            print("city:" + city+ "cityNamee:"+ namee.text +"  latitude:"+ latitude.text , "  longitude:"+longitude.text)
    ...
    excelConvertAPI(citysData,"chinaLonLat2.xls","china")
    
    
    
if __name__=='__main__':
    txtWriteAPI("chinesecity.txt")
    #wikiCrawler(["承德市","沧州市"])